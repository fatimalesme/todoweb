...
// Cargamos los datos de gamificación solo para usuarios registrados
...
<body>
  <div class="app">
    ...
    <!-- SIDEBAR -->
    <aside class="sidebar">
      <h2>Hola, <?= htmlspecialchars($_SESSION['username'] ?? 'Usuario', ENT_QUOTES, 'UTF-8') ?></h2>
    ...
    <main class="main">
      ...
      <!-- main-inner es el contenedor que pone tareas y panel lado a lado -->
